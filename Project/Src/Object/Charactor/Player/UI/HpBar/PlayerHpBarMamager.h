...
#pragma region 定数定義
	// フレームまで含めた全体の大きさ
	const Vector2 HP_BAR_WHOLE_SIZE = Vector2(430.0f, 50.0f);

	// HPバーの分割数
	static constexpr unsigned char HP_BAR_DIVISION_NUM_X = 39;
	...
	const Vector2 HP_BAR_FIRST_POS = Vector2(HP_BAR_ONE_DIVISION_SIZE * 1.5f, HP_BAR_ONE_DIVISION_SIZE * 1.5f);
